...
void loop() {
  ...
  */
  ...
  //  x_move(5, X_RIGHT, 400);
  //  while (TIMSK1 != 0x00);
  //  y_move(5 * tan(radian(30)), Y_UP, 400);
  //  while (TIMSK3 != 0x00);
  //  x_move(5, X_LEFT, 400);
  //  y_move(5 * tan(radian(30)), Y_DOWN, 400 / tan(radian(30)));
  //  while (TIMSK1 != 0x00 || TIMSK3 != 0x00);

  /* 60 60 60 */
  //  x_move(5, X_RIGHT, 400);
  //  while (TIMSK1 != 0x00);
  //  x_move(5 * sin(radian(30)) , X_LEFT, 400 / sin(radian(30)));
  //  y_move(5 * cos(radian(30)), Y_UP, 400 / cos(radian(30)));
  //  while (TIMSK1 != 0x00 || TIMSK3 != 0x00);
  //  x_move(5 * sin(radian(30)), X_LEFT, 400 / sin(radian(30)));
  //  y_move(5 * cos(radian(30)), Y_DOWN, 400 / cos(radian(30)));
  //  while (TIMSK1 != 0x00 || TIMSK3 != 0x00);
}
